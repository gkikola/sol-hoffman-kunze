...
\Exercise6 Let $A$ be an $m\times n$ matrix and $B$ an $n\times k$
...
% \Exercise7 Let $A$ and $B$ be $2\times2$ matrices such that $AB =
% I$. Prove that $BA = I$.
%
% \Exercise8 Let
% \begin{equation*}
...
%   \end{bmatrix}
% \end{equation*}
% be a $2\times2$ matrix. We inquire when it is possible to find
% $2\times2$ matrices $A$ and $B$ such that $C = AB - BA$. Prove that
% such matrices can be found if and only if $C_{11}+C_{22} = 0$.
